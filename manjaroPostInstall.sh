...
echo "====================================================================="
_USUARIO_ATUAL=`who | awk '{print $1}'`
cp face.png /home/"$_USUARIO_ATUAL"/.face

echo "====================================================================="
echo "=============== customizing Bash via ~/.extend.bashrc ==============="
echo "====================================================================="
cat <<EOF > /home/"$_USUARIO_ATUAL"/.extend.bashrc
